...
export JAVAPROJ_NAME=FroggerGame
export JAVAPROJ=/Users/flaviojnsilva/Desktop/UFP/2o_Semestre/SD/FroggerGame

export PACKAGE=session
export PACKAGE_PREFIX=
export PACKAGE_PREFIX_FOLDERS=
export SERVICE_NAME_ON_REGISTRY=SessionService
export CLIENT_CLASS_PREFIX=Session
export SERVER_CLASS_PREFIX=Session
